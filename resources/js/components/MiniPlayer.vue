<template>
  <div v-if="music.hasTrack" class="fixed bottom-4 right-4 z-[9998]" :class="{ 'pointer-events-none': isShortsPage }">

    <!-- Shorts page: hidden completely -->
    <template v-if="isShortsPage"></template>
    ...
    <!-- Hover: medium player -->
    <template v-else-if="state === 'hover'">
