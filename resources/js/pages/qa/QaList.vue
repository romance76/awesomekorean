  ...
  <div class="max-w-7xl mx-auto px-4 py-5">
    ...
    <div class="grid grid-cols-12 gap-4">
      ...
      <div class="col-span-12 lg:col-span-3 hidden lg:block">
        <SidebarWidgets :currentCategory="activeCat?.id || ''" categoryParam="category_id" :inline="true" @select="openItem" api-url="/api/qa" detail-path="/qa/" :current-id="activeItem?.id || 0"
          label="질문" />
